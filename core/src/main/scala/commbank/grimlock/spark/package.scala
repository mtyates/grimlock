...
package object environment {
  ...
  implicit def rddMaterialiseTunerDn = new MaterialiseTuner[Context.U, Default[NoParameters]] { }
  ...
  implicit def rddStreamTunerDr = new StreamTuner[Context.U, Default[Reducers]] { }
