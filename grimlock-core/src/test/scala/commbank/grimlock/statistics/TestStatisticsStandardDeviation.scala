...
class TestScalaStatisticsStandardDeviation extends TestStatistics with TestScala {
  ...
  "A standardDeviation" should "return its correct statistic" in {
    ...
    data1
      .standardDeviation(Along(_0), Default())(false)
      .mapNaN.toList.sortBy(_.position) shouldBe data1
    ...
    data2
      .standardDeviation(Along(_1), Default())(false)
      .mapNaN.toList.sortBy(_.position) shouldBe data2
    ...
    data3
      .standardDeviation(Along(_2), Default())(false)
      .mapNaN.toList.sortBy(_.position) shouldBe data3
...
class TestScaldingStatisticsStandardDeviation extends TestStatistics with TestScalding {
...
class TestSparkStatisticsStandardDeviation extends TestStatistics with TestSpark {
