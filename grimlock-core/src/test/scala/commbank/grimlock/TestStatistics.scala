...
class TestScaldingStatistics extends TestStatistics {
  ...
  "A mean" should "return its correct statistic" in {
    data1
      .mean(Over(_0), Default())
      .toList.sortBy(_.position) shouldBe data1.summarise(Over(_0))(Mean()).toList.sortBy(_.position)

    data1
      .mean(Along(_0), Default(12))
      .toList.sortBy(_.position) shouldBe data1.summarise(Along(_0))(Mean()).toList.sortBy(_.position)

    data2
      .mean(Over(_0), Default())
      .toList.sortBy(_.position) shouldBe data2.summarise(Over(_0))(Mean()).toList.sortBy(_.position)

    data2
      .mean(Along(_0), Default(12))
      .toList.sortBy(_.position) shouldBe data2.summarise(Along(_0))(Mean()).toList.sortBy(_.position)
    ...
    data3
      .mean(Over(_0), Default())
      .toList.sortBy(_.position) shouldBe data3.summarise(Over(_0))(Mean()).toList.sortBy(_.position)

    data3
      .mean(Along(_0), Default(12))
      .toList.sortBy(_.position) shouldBe data3.summarise(Along(_0))(Mean()).toList.sortBy(_.position)
  ...
  "A standardDeviation" should "return its correct statistic" in {
    data1
      .standardDeviation(Over(_0), Default())(true)
      .mapNaN.toList.sortBy(_.position) shouldBe data1
        .summarise(Over(_0))(StandardDeviation(true))
        .mapNaN.toList.sortBy(_.position)

    data1
      .standardDeviation(Along(_0), Default(12))(false)
      .mapNaN.toList.sortBy(_.position) shouldBe data1
        .summarise(Along(_0))(StandardDeviation())
        .mapNaN.toList.sortBy(_.position)
  ...
  "A skewness" should "return its correct statistic" in {
    data1
      .skewness(Over(_0), Default())
      .mapNaN.toList.sortBy(_.position) shouldBe data1.summarise(Over(_0))(Skewness()).mapNaN.toList.sortBy(_.position)

    data1
      .skewness(Along(_0), Default(12))
      .mapNaN.toList.sortBy(_.position) shouldBe data1.summarise(Along(_0))(Skewness()).mapNaN.toList.sortBy(_.position)

    data2
      .skewness(Over(_0), Default())
      .mapNaN.toList.sortBy(_.position) shouldBe data2.summarise(Over(_0))(Skewness()).mapNaN.toList.sortBy(_.position)

    data2
      .skewness(Along(_0), Default(12))
      .mapNaN.toList.sortBy(_.position) shouldBe data2.summarise(Along(_0))(Skewness()).mapNaN.toList.sortBy(_.position)
    ...
    data3
      .skewness(Over(_0), Default())
      .mapNaN.toList.sortBy(_.position) shouldBe data3.summarise(Over(_0))(Skewness()).mapNaN.toList.sortBy(_.position)

    data3
      .skewness(Along(_0), Default(12))
      .mapNaN.toList.sortBy(_.position) shouldBe data3.summarise(Along(_0))(Skewness()).mapNaN.toList.sortBy(_.position)
  ...
  "A sums" should "return its correct statistic" in {
    data1
      .sums(Over(_0), Default())
      .toList.sortBy(_.position) shouldBe data1.summarise(Over(_0))(Sums()).toList.sortBy(_.position)

    data1
      .sums(Along(_0), Default(12))
      .toList.sortBy(_.position) shouldBe data1.summarise(Along(_0))(Sums()).toList.sortBy(_.position)

    data2
      .sums(Over(_0), Default())
      .toList.sortBy(_.position) shouldBe data2.summarise(Over(_0))(Sums()).toList.sortBy(_.position)

    data2
      .sums(Along(_0), Default(12))
      .toList.sortBy(_.position) shouldBe data2.summarise(Along(_0))(Sums()).toList.sortBy(_.position)
    ...
    data3
      .sums(Over(_0), Default())
      .toList.sortBy(_.position) shouldBe data3.summarise(Over(_0))(Sums()).toList.sortBy(_.position)

    data3
      .sums(Along(_0), Default(12))
      .toList.sortBy(_.position) shouldBe data3.summarise(Along(_0))(Sums()).toList.sortBy(_.position)
