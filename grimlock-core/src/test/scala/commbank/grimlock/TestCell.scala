...
class TestCell extends TestGrimlock {
  ...
  "A Cell" should "parse 1D" in {
    ...
    f1("123:double:continuous:3.14") shouldBe List(
      Right(Cell(Position(123L), Content(ContinuousSchema[Double](), 3.14)))
    )
  ...
  "A Cell" should "parse 1D with dictionary" in {
    ...
    f1("123:3.14") shouldBe List(Right(Cell(Position(123L), Content(ContinuousSchema[Double](), 3.14))))
  ...
  "A Cell" should "parse 2D" in {
    ...
    f1("123:def:double:continuous:3.14") shouldBe List(
      Right(Cell(Position(123L, "def"), Content(ContinuousSchema[Double](), 3.14)))
    )
    ...
    f6("123:def:double|continuous:3.14") shouldBe List(Left("Unable to decode: '123:def:double|continuous:3.14'"))
  }

  "A Cell" should "parse 2D with dictionary" in {
    val f1 = Cell.shortStringParser(codecs2a, dictionary, _0, ":")
    f1("123:def:3.14") shouldBe List(Right(Cell(Position(123L, "def"), Content(ContinuousSchema[Double](), 3.14))))
    val f2 = Cell.shortStringParser(codecs2b, dictionary, _1, ":")
    f2("def:123:3.14") shouldBe List(Right(Cell(Position("def", 123L), Content(ContinuousSchema[Double](), 3.14))))
    val f3 = Cell.shortStringParser(codecs2a, dictionary, _0, ":")
    f3("abc:def:3.14") shouldBe List(Left("Unable to decode: 'abc:def:3.14'"))
    val f4 = Cell.shortStringParser(codecs2b, dictionary, _1, ":")
    f4("abc:def:3.14") shouldBe List(Left("Unable to decode: 'abc:def:3.14'"))
    ...
    f7("123|def:3.14") shouldBe List(Left("Unable to decode: '123|def:3.14'"))
  }
  ...
  "A Cell" should "parse 2D with schema" in {
    ...
    f5("123:def|3.14") shouldBe List(Left("Unable to decode: '123:def|3.14'"))
  }

  "A Cell" should "parse 3D" in {
    val f1 = Cell.shortStringParser(codecs3a, ":")
    f1("123:def:ghi:double:continuous:3.14") shouldBe List(
      Right(Cell(Position(123L, "def", "ghi"), Content(ContinuousSchema[Double](), 3.14)))
    )
  ...
  "A Cell" should "parse 3D with dictionary" in {
    ...
    f2("def:123:ghi:3.14") shouldBe List(
      Right(Cell(Position("def", 123L, "ghi"), Content(ContinuousSchema[Double](), 3.14)))
    )
    val f3 = Cell.shortStringParser(codecs3c, dictionary, _2, ":")
    f3("def:ghi:123:3.14") shouldBe List(
      Right(Cell(Position("def", "ghi", 123L), Content(ContinuousSchema[Double](), 3.14)))
    )
    val f4 = Cell.shortStringParser(codecs3a, dictionary, _0, ":")
    f4("abc:def:ghi:3.14") shouldBe List(Left("Unable to decode: 'abc:def:ghi:3.14'"))
    val f5 = Cell.shortStringParser(codecs3b, dictionary, _1, ":")
    f5("abc:def:ghi:3.14") shouldBe List(Left("Unable to decode: 'abc:def:ghi:3.14'"))
    val f6 = Cell.shortStringParser(codecs3c, dictionary, _2, ":")
    f6("abc:def:ghi:3.14") shouldBe List(Left("Unable to decode: 'abc:def:ghi:3.14'"))
    ...
    f9("123|def:ghi:3.14") shouldBe List(Left("Unable to decode: '123|def:ghi:3.14'"))
  }
  ...
  "A Cell" should "parse 3D with schema" in {
    ...
    f5("123:def|ghi:3.14") shouldBe List(Left("Unable to decode: '123:def|ghi:3.14'"))
  }
  ...
  "A Cell" should "parse table" in {
    ...
    f4("3.14:foo:bar") shouldBe Set(
      Left("Unable to decode content: 'foo' - '3.14:foo:bar'"),
      Left("Unable to decode content: 'bar' - '3.14:foo:bar'")
    )
    ...
    f5("3.14:foo") shouldBe List(Left("Out of bounds index: '3.14:foo'"))
  }
